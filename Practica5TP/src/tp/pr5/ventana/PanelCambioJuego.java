...
public class PanelCambioJuego extends JPanel implements ActionListener {
	...
	private static String[] opciones = {"Conecta 4", "Complica", "Gravity", "Reversi", "Tres en raya"};
	...
	public void actionPerformed(ActionEvent e) {
		if("Cambiar".equalsIgnoreCase(e.getActionCommand())){
	        ...
	        else if ("Tres en raya".equalsIgnoreCase(opcion)){
